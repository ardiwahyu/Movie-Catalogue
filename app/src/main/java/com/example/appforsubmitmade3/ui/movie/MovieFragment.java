...
public class MovieFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        movieViewModel.getFilms().observe(this, getFilm);
        movieViewModel.setFilm(getLocale());
        if (!success){
            movieViewModel.getStatus().observe(this, getStatusCode);
        }
            ...
            if (films != null) {
                ...
                adapter.setOnItemClickCallback(new Adapter.OnItemClickCallback() {
                    ...
                    public void onItemClicked(Film data, int position) {
                        ...
                        showDetail.putExtra(DetailActivity.TYPE, "movie");
